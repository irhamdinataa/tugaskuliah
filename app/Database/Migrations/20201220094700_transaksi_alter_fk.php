...
class TransaksiAlterFk extends \CodeIgniter\Database\Migration {
	...
	public function up()
	{
		...
		$this->forge->dropForeignKey('transaksi','transaksi_id_jasa_foreign');
		...
		$this->forge->addColumn('transaksi',[
			'CONSTRAINT transaksi_id_jasa_foreign FOREIGN KEY(id_jasa) REFERENCES jasa(id) ON DELETE NO ACTION ON UPDATE CASCADE',
		]);
	...
	public function down()
	{
		...
		$this->forge->addColumn('transaksi', [
    		'CONSTRAINT transaksi_id_jasa_foreign FOREIGN KEY(id_jasa) REFERENCES jasa(id)',
		]);
